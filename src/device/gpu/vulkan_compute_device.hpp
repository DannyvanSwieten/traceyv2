...
namespace tracey
{
    ...
    public:
        ...
        RayTracingPipeline *createRayTracingPipeline() override;
        ShaderModule *createShaderModule(const RayTracingPipelineLayout &layout, ShaderStage stage, const std::string_view source, const std::string_view entryPoint) override;
